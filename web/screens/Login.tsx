...
export const Login: React.FC<LoginProps> = ({ onLoginSuccess, onGoToSignup, onForgotPassword, onBack }) => {
        ...
        <div className="flex flex-col h-full bg-white relative animate-fade-in">
            ...
            <div className="flex-1 flex flex-col px-8 pt-12 overflow-y-auto">
                ...
                <div className="space-y-4 mb-10">
                    ...
                    <button onClick={handleGoogleLogin} disabled={loading} className="w-full bg-white text-gray-900 border border-gray-200 py-4 rounded-full font-medium flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors active:scale-[0.98] disabled:opacity-70">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-primary hover:bg-primary-hover text-white text-lg font-bold py-4 rounded-full shadow-lg shadow-primary/25 transition-all transform active:scale-[0.98] mt-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                <div className="mt-auto py-10 text-center">
                    <p className="text-gray-500 text-sm font-medium">
                        ¿No tienes una cuenta? <button onClick={onGoToSignup} className="text-primary font-bold hover:underline">Crear cuenta</button>
                    </p>
                </div>
            </div>
        </div>
